...
**第 23 页｜互动：架构选型辩论**  
- 场景：一门 200 人在线课，10 人可能随时上麦，要求录制和字幕  
- 选项：P2P、SFU、MCU、边缘 SFU + 中心媒体服务  
- 建议素材：时延、上行、录制、弱网、成本五维架构选型矩阵  
- 学员互动：小组辩论，每组必须给出成本、时延、录制、弱网、运维复杂度理由  
- 预计讲解：7 分钟  
...
- 选型围绕兼容性、编码成本、画质与场景做平衡  
- 建议素材：编解码矩阵表  
- 学员互动：让学生把“会议、音乐课、弱网移动端、企业互通”贴到不同编解码偏好上  
- 预计讲解：5 分钟  
